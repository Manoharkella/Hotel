...
export default function NearbyAttractions({
  ...
  }, [hotelId, hotelLatitude, hotelLongitude, hotelCity, selectedDistance, selectedCategory, selectedRating, openNowOnly, searchQuery]);
  ...
  return (
    <div className="nearby-attractions-module" style={{ width: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center' }}>
          ...
          <div style={{
            ...
            <input
              type="text"
              placeholder="Search nearby places, monuments, beaches, malls..."
              value={searchQuery}
      ...
      {/* 4. Main Content: Grid vs Map View */}
      {loading ? (
        <div style={{ textAlign: 'center', padding: '60px 20px', background: '#FFFFFF', borderRadius: 14, border: '1px solid #E2E8F0' }}>
          ...
          <p style={{ marginTop: 14, color: '#64748B', fontWeight: 600, fontSize: '0.9rem' }}>
            Locating tourist spots around {hotelName}...
          </p>
        </div>
      ) : error ? (
        ...
        <div style={{ textAlign: 'center', padding: '60px 20px', background: '#FFFFFF', borderRadius: 14, border: '1px solid #E2E8F0' }}>
          ...
          <p style={{ color: '#64748B', fontSize: '0.85rem', maxWidth: 400, margin: '0 auto 16px' }}>
            We couldn't find any places matching your current filters within the selected distance.
          </p>
          <button
            type="button"
            onClick={() => {
            ...
            >
              ...
              <div style={{ padding: '14px 16px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                ...
                <div style={{
                  ...
                  <a
                    href={spot.google_maps_url || `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(spot.name + ' ' + (spot.city || ''))}`}
                    target="_blank"
              ...
              <Popup>
                <div style={{ padding: 4, minWidth: 160 }}>
                  ...
                  <div style={{ fontSize: '0.75rem', color: '#64748B', marginTop: 2 }}>
                    Your Departure Reference Point
                  </div>
                </div>
              </Popup>
            </Marker>
